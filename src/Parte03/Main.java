    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (!(robo01.verificarEncontradoAlimento(alimento))) {
                ...
                System.out.printf("Robô %s NORMAL encontrou o alimento, não irá mover!\n", robo01.getCor());
            }
            ...
            if (!(robo02.verificarEncontradoAlimento(alimento))) {
                ...
                System.out.printf("Robô %s INTELIGENTE encontrou o alimento, não irá mover!\n", robo02.getCor());
            }

        } while (!(robo01.verificarEncontradoAlimento(alimento) && robo02.verificarEncontradoAlimento(alimento)));
